...
function ensureOrlSeed() {
  try {
    ...
    const orlMedicos = [
      ...
      // Grupo Justo Salud. Matricula sacada de sus propios informes (un ECG de
      // Cardozo y una ergometria de Pugliese, ago/2026), los dos firmados por el.
      ...
      // cuello suyo (Bissio, 03/08/2026). Ademas del cuello (10 pendientes) firma
      // los ecodoppler de miembros inferiores, venoso (5) y arterial (4). El
      // ecodoppler cardiaco NO es suyo: queda sin asignar hasta saber quien lo hace.
      { id: "ramirez-walter", nombre: "Dr. Walter Ramirez", matricula: "M.N. 119.078 · M.P. 33.293",
        ...
        clientes: ["st-ignacio"] },
      // Cardiologo. Firma las presurometrias de 24 hs del centro (Ledesma,
      // 03/08/2026) y tambien los Holter: entre los dos son 47 pendientes, lo mas
      // grande que quedaba sin medico. Las dos matriculas salen del sello del
